...
var Beta = function () {
  ...
  _createClass(Beta, [{
    ...
    value: function probability(y) {
      ...
      return (0, _gamma3.default)(this.alpha + this.beta) / ((0, _gamma3.default)(this.alpha) * (0, _gamma3.default)(this.beta)) * Math.pow(y, this.alpha - 1) * Math.pow(1 - y, this.beta - 1);
    }
  }, {
    key: "_mean",
